-- SQL query to extract the first name, city of birth, date of birth, and province from the text in the dqlabdatateks table
SELECT 
...
-- SQL query to extract the whole info from the text in the dqlabdatateks table
SELECT 
LEFT(isi, LOCATE('|||', isi) - 1) as Nama, 
